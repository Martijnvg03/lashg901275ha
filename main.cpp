...
//code changes
#pragma region changesTocode
//todo - 12.04.2022 ( skengdo )
/*
* Fix random bsod ( semi fixed )
* Fix random memory dumps
* better allocate memory method 
* improve code ( optimize )
* change driver method to physical memory 
* allow sections to be called 
* call dll from any hook | current WH_MOUSE
* fix imports not being able to inject into process
*/
...
/*
* fixed injection into rust + eft 
* fixed random op codes filtering out assembly code
* fixed stupid imports getting filtered out
* recoded driver entry point to dll_image
* allowed for bigger dlls to be injected into process
*/
